...
| Quality Assurance | Generate Test Cases, Generate Test Data, Generate Test Automation Script, Accessibility Agent, API Test Generator |
...
<AccordionGroup>
  ...
  <Accordion title="Accessibility Agent (Quality Assurance)">
    - Description: Analyse and improve UI accessibility for all users using AI.
    - **Parameters:**
      - Page URL
      - WCAG 2 Level
    - **Use cases:** Analyse a page URL for accessibility issues against the selected WCAG 2 level and receive actionable recommendations to improve compliance and usability.
  </Accordion>

  <Accordion title="Generate API Tests (Quality Assurance)">
  </Accordion>
</AccordionGroup>
...
<Note>
  Actions can be combined and customised in any workflow. For inspiration, see the  page, or visit the  for a step-by-step guide.
</Note>