...
<Tip>
More workflow templates are coming soon! If you need a specific workflow template, please <a href="https://tiqtoq-uk.atlassian.net/servicedesk/customer/portal/4" target="_blank" rel="noopener noreferrer">contact our support team</a> to request one. Stay tuned for new templates and automation capabilities.
</Tip>
...
<Step title="Open the Templates Page">
    ...
    <Frame caption="Templates overview UI">
        <img src="/images/Screenshot-2026-06-05-154649.png" alt="Templates overview" />
    </Frame>
</Step>
<Step title="Select a Template">
    ...
    <Frame caption="Template selection UI">
        <img src="/images/Screenshot-2026-06-05-155035.png" alt="Template selection" />
    </Frame>
</Step>
